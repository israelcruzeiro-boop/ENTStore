    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md bg-zinc-900 rounded-2xl shadow-2xl overflow-hidden border border-zinc-800">
        <div className="p-8 text-center border-b border-zinc-800">
          <h1 className="text-3xl font-bold text-white mb-2">ENT<span className="text-[var(--c-primary,#3b82f6)]">Store</span></h1>
          ...
          <div className="space-y-4">
            {MOCK_USERS.map(user => (
              <button
                ...
                className="w-full flex items-center justify-between p-4 rounded-xl border border-zinc-800 hover:border-zinc-600 bg-zinc-800/50 hover:bg-zinc-800 transition-all group cursor-pointer"
              >
                <div className="text-left">
                  <div className="font-medium text-white group-hover:text-[var(--c-primary,#60a5fa)] transition-colors">{user.name}</div>
