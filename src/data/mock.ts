...
export const MOCK_USERS: User[] = [
  { id: 'u1', name: 'Super Admin', email: 'sadmin@storepage.com', role: 'SUPER_ADMIN' },
  { id: 'u2', name: 'Admin Company', email: 'admin@storepage.com', role: 'ADMIN', company_id: 'c1' },
  { id: 'u3', name: 'User Premium', email: 'user@storepage.com', role: 'USER', company_id: 'c1', avatar_url: 'https://i.pravatar.cc/150?u=u3' },
];
